...
#include "PrototypeSkeletalItem.h"

APrototypeSkeletalItem::APrototypeSkeletalItem()
{
	// Set this actor to call Tick() every frame.  You can turn this off to improve performance if you don't need it.
	PrimaryActorTick.bCanEverTick = true;
}

void APrototypeSkeletalItem::CleanMesh()
{
...
void APrototypeSkeletalItem::OnConstruction(const FTransform& Transform)
{
